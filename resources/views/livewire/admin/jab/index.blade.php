                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn m-1 btn-creative btn-success"
                                   href="{{route('jab.edit',$jab)}}"><i class="fa fa-pencil"></i>
                                </a>

                                <a class="btn m-1 btn-creative btn-danger" wire:click="deletejab({{ $jab->id }})"
