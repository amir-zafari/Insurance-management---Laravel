    ...
    <div class="header-area" id="headerArea">
        <div class="container">
            ...
            <div class="header-content position-relative d-flex align-items-center justify-content-between">
                <!-- Back Button -->
                <div class="back-button"><a href="/jab">
...
{{ route('jab.trashed') }}
                            ...
                            ({{\App\Models\jab::onlyTrashed()->count()}})  سطل زباله</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="card">
                <div class="card-body">
                    ...
                    <form wire:submit.prevent="jabForm" enctype="multipart/form-data" role="form">
                        <div class="input-group mb-3"><span class="input-group-text">نام شغل</span>
                            <input class="form-control" wire:model.lazy="jab.name"  type="text" aria-label="First name" placeholder="نام">
                        </div>
